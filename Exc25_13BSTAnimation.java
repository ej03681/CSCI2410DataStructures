...
public class Exc25_13BSTAnimation extends Application {
	...
	public void start(Stage primaryStage) {
		...
		keyT.setPrefColumnCount(3);
		keyT.setAlignment(Pos.BASELINE_RIGHT);

		Button insert = new Button("Insert");
		insert.setPrefWidth(70);
		Button delete = new Button("Delete");
		delete.setPrefWidth(70);
		Button show1 = new Button("Inorder");
		show1.setPrefWidth(70);
		Button show2 = new Button("Preorder");
		show2.setPrefWidth(80);
		Button show3 = new Button("Postorder");
		show3.setPrefWidth(90);

		HBox box = new HBox(8);
		box.getChildren().addAll(new Label("Enter a key: "), keyT, insert, delete, show1, show2, show3);

		pane.setBottom(box);

		insert.setOnAction(e -> {
			int key = Integer.parseInt(keyT.getText());
			if (tree.search(key)) {
				view.displayTree();
	...
	public class BSTView extends Pane {
		...
		public void displayTree() {
			...
			if (tree.getRoot() != null) {
				...
				displayTree(tree.getRoot(), getWidth() / 2, getHeight() / 4, 60);
